...
class Clean_Extract():
    ...
    #Class which consists of methods to extract and clean text in corpora
    ...
    def Word_Array(self,M):
        ...
        #Function to get all occuring words in the corpora 
    ...
    def Remove_Bracket(self,ar):
        ...
        #Remove special charecters such as brackets and paranthesis
...
Data=open("NYSE.txt","r",encoding='cp1252')
